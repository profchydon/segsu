...
contract SEGSU is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 constant _burnPercentage = 40;

    uint8 constant _teamTokenPercentage = 27;
    ...
    uint256 public _teamToken = _tTotal.mul(_teamTokenPercentage).div(10**2);
    uint256 public _adminToken = _tTotal.mul(_adminTokenPercentage).div(10**2);
    uint256 public _mgmtToken = _tTotal.mul(_mgmtTokenPercentage).div(10**2);
    uint256 public _numTokenToBurn = _tTotal.mul(_burnPercentage).div(10**2);
